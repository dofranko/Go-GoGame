...
public class ReplayGame extends JFrame {
		...
		downloadGameButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					gameIDTextField.setText("Podaj liczbę");
				}
	...
	protected void updateGameBoard(String stonesInString) {
		...
		case "poddanie sie":
			...
			break;
		case "zwycięstwo":
			this.playerColorMoveJLabel.setText(playerColorMoveJLabel.getText() + "wygrywa.");
			break;
		case "remis":
			this.playerColorMoveJLabel.setText(playerColorMoveJLabel.getText() + "remisuje.");
			break;
		}
	...
	private List<MovesEntity> downloadGameData(int gameID) throws IllegalArgumentException {
		...
		playersJLabel.setText("<html><pre>Zawodnicy:\nBiały: " + game.getWhitePlayerId() + "\tCzarny: "
				+ game.getBlackPlayerId() + "</pre></html>");
